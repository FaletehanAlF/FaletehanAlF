...
Halo, saya **Faletehan Al Farabi** — pelajar jurusan **Rekayasa Perangkat Lunak (RPL)** di **SMK Taruna Bhakti**.

Saya tertarik pada pengembangan aplikasi web modern, perancangan pengalaman pengguna (UI/UX) yang intuitif, dan eksplorasi teknologi baru dalam dunia software development.

- 🚀 Fokus pada **Web Development**
- 🎨 Menekuni **UI/UX Design**
- 🤖 Belajar tentang **Artificial Intelligence**
- 📚 Terus mengembangkan skill melalui proyek nyata
...
<img src="https://skillicons.dev/icons?i=html,css,js,ts,react,nextjs,tailwind,vite,flutter" alt="Frontend stack" />

**Backend**

<img src="https://skillicons.dev/icons?i=nodejs,php,laravel,go,express" alt="Backend stack" />

**Database & Backend Services**

<img src="https://skillicons.dev/icons?i=supabase,postgres,mysql,sqlite,firebase" alt="Database stack" />

**Design & Tools**

<img src="https://skillicons.dev/icons?i=figma,ai,git,github,gitlab,vscode,vercel,netlify" alt="Design and tools" />
